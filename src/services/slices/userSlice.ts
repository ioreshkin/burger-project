...
export const fetchRegister = createAsyncThunk<
  IRegisterResponse,
  IRegisterRequest
>('user/fetchRegister', async (data, { rejectWithValue }) => {
  try {
...
>('user/fetchResetPassword', async (data, { rejectWithValue }) => {
  try {
...
export const fetchGetUser = createAsyncThunk<IGetUserResponse>(
  ...
  async (_, { rejectWithValue }) => {
    try {
      return await requestWithAuth('auth/user', {
        headers: {
...
export const fetchPatchUser = createAsyncThunk<
  IGetUserResponse,
  IPatchUserRequest
>('user/fetchPatchUser', async (data, { rejectWithValue }) => {
  try {
    const reqData = {
      name: data.name,
      email: data.email,
