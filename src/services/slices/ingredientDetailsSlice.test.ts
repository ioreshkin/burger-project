...
describe('ingredientDetailsSlice', () => {
    ...
    describe('reducers', () => {
        ...
        it('should handle reset', () => {
            ...
            const stateWithIngredient = ingredientDetailsSlice.reducer(initialState, setAction);

            const resetAction = ingredientDetailsSlice.actions.reset();
            const resetState = ingredientDetailsSlice.reducer(stateWithIngredient, resetAction);
